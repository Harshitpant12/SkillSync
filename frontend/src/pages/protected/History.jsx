    ...
    <div className="min-h-screen w-full bg-gray-50 flex font-sans">
      ...
      >
        ...
        <nav className="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
          ...
          <button
            onClick={() => setIsSidebarOpen(false)}
            className="w-full flex items-center gap-3 px-4 py-3 bg-gray-800 text-white rounded-xl font-medium transition-colors"
          >
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 sm:gap-6 mb-8 sm:mb-10">
              ...
              <div className="relative w-full md:w-72">
                ...
                <input
                  ...
                  className="w-full bg-white border border-gray-200 text-gray-900 placeholder-gray-400 rounded-xl pl-10 pr-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all shadow-sm text-sm sm:text-base"
                />
              </div>
            </div>

            {isLoading ? (
              <div className="bg-white rounded-2xl sm:rounded-3xl border border-gray-200 shadow-sm p-8 sm:p-12 flex flex-col items-center justify-center min-h-100">
                <Loader2
                  size={40}
              ...
              <div className="bg-red-50 rounded-2xl sm:rounded-3xl border border-red-100 p-8 sm:p-12 flex flex-col items-center justify-center min-h-100 text-center">
              ...
              <div className="bg-white rounded-2xl sm:rounded-3xl border border-gray-200 shadow-sm p-8 sm:p-12 flex flex-col items-center justify-center min-h-100 text-center">
                ...
                {!searchQuery && (
                  <Link
                    to="/dashboard"
                    className="bg-blue-600 text-white px-6 py-3 rounded-xl font-bold hover:bg-blue-700 transition-colors shadow-md shadow-blue-600/20 text-sm sm:text-base"
                  >
                    Run New Scan
                  </Link>
                )}
              ...
              <div className="bg-white rounded-2xl sm:rounded-3xl border border-gray-200 shadow-sm overflow-hidden w-full">
                <div className="overflow-x-auto">
                  <table className="w-full text-left border-collapse min-w-150">
                    <thead>
                      <tr className="bg-gray-50 border-b border-gray-200 text-xs sm:text-sm text-gray-500 uppercase tracking-wider font-jetbrains">
                        ...
                        >
                          <td className="px-4 sm:px-6 py-4">
                            <div className="flex items-center gap-3">
                              ...
                              <span className="font-bold text-sm sm:text-base text-gray-900 truncate max-w-30 sm:max-w-xs md:max-w-sm">
                                {item.resumeFileName}
                              </span>
                            </div>
                          </td>
                          ...
                          <td className="px-4 sm:px-6 py-4 whitespace-nowrap">
                            <Link
                              to={`/results/${item._id}`}
                              className="inline-flex items-center gap-1 text-xs sm:text-sm font-bold text-blue-600 hover:text-blue-700 transition-colors group-hover:translate-x-1 duration-200"
                            >
